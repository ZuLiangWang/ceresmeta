...
const (
	...
	stateSplitCreateShardTables      = "StateDelete"
...
var (
	splitEvents = fsm.Events{
		...
		{Name: eventSplitOpenNewShard, Src: []string{stateSplitCreateNewShardView}, Dst: stateSplitOpenNewShard},
		{Name: eventSplitDeleteShardTables, Src: []string{stateSplitOpenNewShard}, Dst: stateSplitDeleteShardTables},
